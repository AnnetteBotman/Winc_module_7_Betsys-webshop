from models import db, User, Product, Tag, ProductTag, WebshopTransaction


def populate_database():
    db.connect()

    db.create_tables([User, Product, Tag, ProductTag, WebshopTransaction])

    User.create(
        name="Pietje Bell",
        adress="Stationstraat 1",
        postcode="7481AA",
        town="Enschede",
        billing_info="SNS123456",
    )
    User.create(
        name="Anna Jansen",
        adress="Dorpsplein 5",
    ...
    User.create(
        ...
        postcode="4255ZX",
        town="Eindhoven",
        billing_info="ING123456",
    )

    Product.create(
        name="Sweater",
        description="Brown sweater with text Holiday",
    ...
    Product.create(
        name="Trousers",
        description="Blue trousers, size M",
        price_per_unit=20,
        stock=10,
        owner=1,
    )
    Product.create(
        name="Socks",
        description="Blue socks, size 39-42",
        price_per_unit=5,
        stock=10,
        owner=1,
    )
    Product.create(
        name="Sweater",
        description="Blue sweater,plain",
    ...
    Product.create(
        name="Jeans",
        description="Dark bleu jeans, size 30/32",
        price_per_unit=35.95,
        stock=1,
        owner=2,
    )
    Product.create(
    ...
    Product.create(
        name="Hand mixer",
        description="Hand mixer, Philips",
        price_per_unit=37.95,
        stock=10,
        owner=2,
    )
    Product.create(
        name="Washing machine",
        description="Washing machine AEG",
        price_per_unit=100,
        stock=2,
        owner=3,
    )
    Product.create(
        name="Suitcase",
        description="Suitcase, blue, 80x40x20cm",
        price_per_unit=25,
        stock=2,
        owner=3,
    )
    Product.create(
        name="Suitcase",
        description="Suitcase, red, 80x40x20cm",
        price_per_unit=25,
        stock=10,
        owner=3,
    )
    Product.create(
        name="Tennisracket",
        description="Tennisracket, adults, Dunlop",
        price_per_unit=30,
        stock=2,
        owner=3,
    )
    Product.create(
        name="Tennisracket",
        description="Tennisracket, junior, Dunlop",
        price_per_unit=25,
        stock=5,
        owner=1,
    )
    Product.create(
        name="Tennisshort",
        description="Tennisshort, white, size M",
    ...
    Product.create(
        name="Sportsbag",
        description="Sportsbag, black, medium",
    ...
    Product.create(
        name="Sportsbag",
        description="Sportsbag, black, large",
        price_per_unit=31.95,
        stock=10,
        owner=3,
    )
